            ...
            <ul class="navbar-nav float-rigth">
              ...
              "
                    ...
                    <ul class="dropdown-menu dropdown-menu-end user-dd animated" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item" href="{{route('mi-cuenta')}}"><i class="mdi mdi-account me-1 ms-1"></i>
                            Mi cuenta</a>
                        ...
                        <form action="{{route('logout')}}" method="POST" id="formlogout">
                            @csrf
                            <button type="submit" class="dropdown-item"><i class="fa fa-power-off me-1 ms-1"></i> Cerrar sesión</button>                        </form>
                        <div class="dropdown-divider"></div>
                        <div class="ps-4 p-10">
