...
@section('styles')
{{-- <link rel="stylesheet" href="{{asset('assests/back/extra-libs/nestable/jquery.nestable.min.css')}}" type="text/css"> --}}
<style type="text/css">    
    /**
     * Nestable
     */
...
@endsection
@section('scripts')
<script src="{{asset('assets/back/js/pages/menu/index.js')}}" type="text/javascript"></script>       
@endsection
@section('contenido')
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="card">
            <div class="card-header bg-info">
                ...
                <a href="{{route('menu.crear')}}" class="btn btn-dark btn-sm float-right">Crear</a>
            </div>
